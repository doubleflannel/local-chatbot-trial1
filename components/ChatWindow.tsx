    ...
    <>
      <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden flex flex-col">
        <h1 className="text-3xl md:text-4xl mb-2 ml-auto mr-auto">
          🆔 Indigo - Proof-Of-Concept Local Chat with Documents 🆔
        </h1>
        ...
        <ul>
          <li>
            ⚙️
            <span className="ml-2">
              The default LLM is Mistral run locally by Ollama. Using your macOS Terminal window, run the following command to give this site access to the locally running model:
              <br/>
              <pre className="inline-flex px-2 py-1 my-2 rounded">OLLAMA_ORIGINS=https://local-chatbot-trial1.vercel.app OLLAMA_HOST=127.0.0.1:11435 ollama serve
              </pre>
              <br/>
